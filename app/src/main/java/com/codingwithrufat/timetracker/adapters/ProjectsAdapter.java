...
import com.codingwithrufat.timetracker.helper.timer.TimeConverter;
...
public class ProjectsAdapter extends RecyclerView.Adapter<ProjectsAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
                       ...
                       if (projects.get(position).getEnded()!=null)
                           holder.project_time.setText(TimeConverter.convertToHourFormat(projects.get(position).getEnded()));
                       if (projects.get(position).getStart()!=null)
                           holder.project_time.setText(TimeConverter.convertToHourFormat(projects.get(position).getStart()));
                       if (projects.get(position).getStart()!=null && projects.get(position).getEnded()!=null)
                           holder.project_time.setText(TimeConverter.convertToHourFormat(projects.get(position).getEnded()-projects.get(position).getStart()));
